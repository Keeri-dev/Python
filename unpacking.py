...
##### It turns out there are other ways to unpack variables. You can write more powerful and elegant code by understanding how to unpack variables in seemingly more advanced ways.
...
##### Notice how a list called coins is created. We can pas each value in by indexing using 0,1, and so on.
#### This is getting quite verbose. Wouldn't it be nice if we could simply pass the list of coins to our function?

#### To enable the possibility of passinng the entire list, we can use unpacking.
...
##### When you start talking about "names" and "values", dictionaries might start coming to mind!
#### You can implement this as a dictionary.
...
##### In this text editor window, code as follows:
