...
##### Lets assume that this program will be gettting much more complicated.
...
##### We can also program more cleanly, such that our user can get some info about the proper usage of our code when they fail touse the program correctly.
...
#### Now, if the user executes python argparse.py --help or -h, the user will be presented with some clues about how to use this program.
