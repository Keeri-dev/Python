...
####### One of the reasons Python is so popular is that there's numerous powerful thrid-party libraries that add funtionality.
...
# In your terminal window type code say.py.
...
# Notice that a t-rex is no saying "hello"
